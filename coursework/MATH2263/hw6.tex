...
\noindent The equation for the \textbf{osculating plane} at $t = 0$ is $\| \vec{N} \times \vec{T}\|_{t = 0} = $\\\\
\noindent The equation for the \textbf{normal plane} at $t = 0$ is $ \| \vec{B} \times \vec{N}\|_{t = 0} = $\\\\
\noindent The equation for the \textbf{rectifying plane} at $t = 0$ is $ \| \vec{B} \times \vec{T}\|_{t = 0} = $\\\\
