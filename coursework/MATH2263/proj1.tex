...
\end{vmatrix}
\frac{1}{\sqrt{t^{4} + 5t^{2} + 8}^{2}}\\\\ $
$\\\\=[(-2sin(t)-tcos(t))(-3sin(t) - tcos(t))] - [(-3cos(t)+tsin(t))(2cos(t)-tsin(t))] \frac{1}{t^{4} + 5t^{2} + 8}
\\\\=\frac{t^{2} + 6}{t^{4} + 5t^{2} + 8} $\\\\
...
\begin{tikzpicture}
  \begin{axis}[
	  ...
	  \addplot[mark=none, ultra thick]{(x^2+6)/(x^4+5*x^2+8)};
\end{axis}
\end{tikzpicture}
